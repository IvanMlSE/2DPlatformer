...
public class EagleMovement : MonoBehaviour
{
    ...
    {
        if (Mathf.Abs(_targetVector.x - _currentPosition.x) < Constant.PointReachabilityError &&
            Mathf.Abs(_targetVector.y - _currentPosition.y) < Constant.PointReachabilityError)
        {
    ...
    {
        public const float PointReachabilityError = 0.1f;
    }
}